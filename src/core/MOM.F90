...
subroutine get_MOM_state_elements(CS, G, GV, US, Reg, Tv, C_p, C_p_scaled, h, use_temp)
  ...
  type(thermo_var_ptrs),      optional              :: tv   !< structure containing pointers 
                                                            !! to available thermodynamic fields
